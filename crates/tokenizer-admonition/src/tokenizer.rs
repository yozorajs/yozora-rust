...
struct TokenData {
    ...
    marker_count: usize,
    indent: usize,
    title_line: Option<PhrasingContentLine>,
    body_lines: Vec<PhrasingContentLine>,
}
...
impl MatchBlockHook for AdmonitionMatchHook<'_> {
    ...
    fn eat_continuation_text(
        ...
        token.children = self.api.rollback_phrasing_lines(&body_lines, None);
