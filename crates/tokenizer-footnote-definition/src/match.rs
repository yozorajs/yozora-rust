...
pub(crate) struct FootnoteDefinitionBlockToken {
...
pub(crate) fn match_footnote_definition(lines: &[&str]) -> Option<FootnoteDefinitionBlockToken> {
    ...
    Some(FootnoteDefinitionBlockToken {
