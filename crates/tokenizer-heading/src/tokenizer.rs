...
use crate::types::HEADING_TOKENIZER_NAME;
...
pub struct HeadingMatchHook;

impl HeadingMatchHook {
    pub fn new() -> Self {
        Self
    }
}
...
pub struct HeadingParseHook<'a> {
    api: &'a dyn ParseBlockPhaseApi,
}

impl<'a> HeadingParseHook<'a> {
